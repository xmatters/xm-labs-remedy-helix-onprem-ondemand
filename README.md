...
# Files
[BMCRemedyandHelixIncident74.zip](BMCRemedyandHelixIncident74.zip) - download this Workflow to get started  
...
### Import the Workflow
* Import the **BMC Remedy and Helix | Incident | 7.4** (BMCRemedyandHelixIncident74.zip) Workflow     https://help.xmatters.com/ondemand/xmodwelcome/workflows/manage-workflows.htm

### Assign permissions to the Workflow and Form  
* On the *Workflows* page, click the Edit drop-down menu for the **BMC Remedy and Helix | Incident | 7.4** then select **Editor Permissions**
* Add any users, groups and/or roles to have editor permissions to this workflow
* On the *Workflows* page, click the **BMC Remedy and Helix | Incident | 7.4** then click **Forms**
...
* On the *Workflows* page, click the **BMC Remedy and Helix | Incident | 7.4** then click **Properties**
...
* On the *Workflows* page, click the **BMC Remedy and Helix | Incident | 7.4** then click **Flows**
...
* On the *Workflows* page, click the **BMC Remedy and Helix | Incident | 7.4** then click **Integration Builder**
